...
<a class="navbar-brand" href="index.php"><img src="https://coexma.com.py/assets/site/imagens/coexma.png" alt="" class="img-fluid"></a>
                    ...
                    <?php foreach ($menu as $mainmenu) { ?>  
                        <div class="col-md-3">
                            <div class="col-megamenu">
                            	<h6 class="title"><?php echo $mainmenu['orden'] ?><?php echo $mainmenu['nombre']; ?></h6>
                              ...
                              $submenu = getAllMenuCategorias($mainmenu['id'],'menu');
                                  if ($submenu) {
                                      foreach ($submenu as $subm) { ?>
                                          ...
                                          <a href="categoria.php?cat=<?php echo $subm['id'] ?>" <?php if ($subm['id'] == 166) { echo "style='font-weight: 800;color: var(--danger);' ";}?>><?php echo $subm['orden'] ?><?php echo $subm['nombre'] ?>
                                          </a>
                                          </li>
