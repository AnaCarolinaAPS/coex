    ...
    $(document).ready(function(){
        $(document).on('shown.bs.modal','#AltModal', function (event) {
            ...
            var modal = $(this)
            modal.find('.modal-title').text('Unidad ' + nombre);
            modal.find('#codigo').val(codigo);
            modal.find('#nombre').val(nombre);
            modal.find('#imgurl').val(url);
            modal.find('#direccion').val(direccion);
            modal.find('#telefonos').val(telefonos);
            modal.find('#horarios').val(horarios);
            
            document.getElementById("img-alt").src="../img/unidades/"+url;
